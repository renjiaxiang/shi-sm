...
require_once jylbsh_ROOT . '/admin/common/bootstrap.sys.inc.php';
require_once jylbsh_ROOT . '/admin/common/template.func.php';
require_once jylbsh_ROOT . '/admin/common/common.func.php';
// require_once jylbsh_ROOT . '/admin/common/file.func.php';
...
function _forward($c, $a) {
	$file = jylbsh_ROOT . '/admin/source/' . $c . '/' . $a . '.ctrl.php';
	return $file;
}
